...
DROP TABLE IF EXISTS mls.listings;
CREATE EXTERNAL TABLE IF NOT EXISTS mls.listings
( created_datetime timestamp,
 ...
 state_raw string,
 zip_raw string,
 asg_primary_id bigint,
 asg_primary_id_final_flag boolean,
 source string,
 ...
 load_date string
) COMMENT 'MLS listings curated'
STORED AS ORC
LOCATION '/data/curated/mls/listings/'
